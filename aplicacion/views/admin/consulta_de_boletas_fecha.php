      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <table class="data-table table stripe hover nowrap">
             ...
             <tbody>
             	<?php
             	   $sql = ("SELECT * FROM boletas_pago INNER JOIN empleado ON boletas_pago.id_empleado=empleado.id_empleado WHERE fecha>='$fecha1' AND fecha<='$fecha2' ORDER BY boletas_pago.id_boletas_pago DESC"); 
