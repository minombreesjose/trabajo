        ...
        <div class="col-xs-12"><br><br>
              <table class="table">
                ...
                <tr>
                  ...
                  <?php 
                      $hoy=date("Y-m-d");
                        $con=("SELECT *FROM salida_mercancia INNER JOIN mercancia ON salida_mercancia.id_mercancia=mercancia.id_mercancia INNER JOIN tipo ON mercancia.id_tipo_mercancia=tipo.id_tipo INNER JOIN marca ON mercancia.id_marca_mercancia=marca.id_marca WHERE salida_mercancia.fecha_salida='$hoy'");
                        //die($con);
