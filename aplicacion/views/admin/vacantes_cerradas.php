           ...
           <!--Tabla de Consulta de Usuario -->
            <h4>Vacantes cerradas</h4><br>
             ...
             <tbody>
             	...
             	<?php
             	   $sql = ("SELECT * FROM vacante WHERE status='1'"); 
                ...
                <td><?php echo $usuario['fecha_publicacion']; ?> <?php echo $usuario['hora']; ?></td>
             		<td>
             			<?php if ($usuario['status']=='1') {?>
             				<a href='../../controllers/activar/activar_vacante.php?id_vacante=<?php echo $usuario["id_vacante"]; ?>' class="btn btn-success">Activar</a>
