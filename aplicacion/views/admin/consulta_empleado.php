...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <!-- tabla  -->
           ...
           <a href="empleados_inhabilitados.php"><i class="icon-copy fa fa-mail-reply" aria-hidden="true"></i> <b>Empleados Inhabilitados</b></a>
           <p align="right">
              <a class="btn btn-secondary" href="#" onclick="window.open('imprimir/empleado.php', 'Nuestros Empleados', 'width=700, height=505, ');"><i class="icon-copy fi-print"></i> Imprimir
              </a>
            </p>
           <!--Tabla de Consulta de Usuario -->
            <h4>Nuestros Empleados Activos</h4><br>
