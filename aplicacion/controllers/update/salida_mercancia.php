...
if ($cantidad_salida>$s) {
   header("Location:../../views/admin/salida_mercancia.php?msj=sobre_girado"); 
}elseif ($cantidad<=$s) {
...
$sql = ("UPDATE salida_mercancia SET cantidad_salida='$cantidad_salida',total_pagar='$total_pagar' WHERE id_salida_mercancia='$id_salida_mercancia'");    
        if (mysqli_query(conexion::con(), $sql)) {
               header("Location:../../views/admin/salida_mercancia.php?msj=actualizado"); 
           }else{
               header("Location:../../views/admin/salida_mercancia.php?msj=error_update"); 
        }
}
?>